...
# ====================================================== Resnet50 ======================================================
## Refer to: torchvision.models.resnet50
...
class ResnetFPN(nn.Module):
    ''' Resnet50 + FPN
        Refer to: jwyang/faster-rcnn.pytorch, detectron2'''
    def __init__(self):
...
if __name__ == "__main__":
    # Tests
    net1 = ResNet50()
    input1 = torch.randn((1,3,224,224))  # NCHW
    output1 = net1(input1)
    print(output1.shape)

    net2 = ResnetFPN()
    input2 = torch.randn((1, 3, 224, 224))  # NCHW
    output2 = net2(input2)
    print(output2.shape)
